...
layout(location = 5) uniform sampler2D texApt;
layout(location = 6) uniform int cursorPosX;
layout(location = 7) uniform int cursorPosY;
layout(location = 8) uniform int quadID;
layout(location = 9) uniform bool getGhostsAtMouse;
...
layout(std430, binding = 4) buffer QuadIDBuffer {
    QuadData quadData[];
};

layout(binding = 5, offset = 0) uniform atomic_uint quadIDCounter;
